...
; Keyboard helper routines

.module KeyboardInput

; Load a keyboard table
; This function searches for a scancode translation table
; on the calculator's memory using Ion's program detection.
...
; Translate a key based from the scancode to an ASCII-ish equivalent.
